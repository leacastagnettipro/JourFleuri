...
export default function Footer() {
  ...
  return (
    <footer className="bg-jour-fleuri-rose-pale py-10 md:py-12 px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                <Mail size={18} />
                <span>louisecarton@jourfleuri.com</span>
              </a>
              <a
